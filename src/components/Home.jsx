   ...
   return (
      <>
         <div className="main bg-[-38rem_0rem] sm:bg-right-top flex overflow-hidden relative flex-col justify-start text-white capitalize min-h-[769px]">
            <div className="z-10 px-12 flex relative top-20 flex-col items-start w-full max-lg:max-w-full">
               <div className="poppinsFont text-6xl leading-[105px] w-[678px] max-lg:mt-10 max-lg:max-w-full max-lg:text-4xl ">
